        ...
        $(window).on("scroll", function() {
          if($(window).scrollTop() > 50) {
            ...
            <!-- container (chart - welcome) -->
              <div class='questionaire_container' style=''>
                <div class="panel-body">
                  <div class="typeform-widget" data-url="https://saul48.typeform.com/to/mwSd0r" style="width: 100%; height: 500px;" > </div> <script> (function() { var qs,js,q,s,d=document, gi=d.getElementById, ce=d.createElement, gt=d.getElementsByTagName, id="typef_orm", b="https://embed.typeform.com/"; if(!gi.call(d,id)) { js=ce.call(d,"script"); js.id=id; js.src=b+"embed.js"; q=gt.call(d,"script")[0]; q.parentNode.insertBefore(js,q) } })() </script> <div style="font-family: Sans-Serif;font-size: 12px;color: #999;opacity: 0.5; padding-top: 5px;" > powered by <a href="https://www.typeform.com//?utm_campaign=mwSd0r&amp;utm_source=typeform.com-11670540-Basic&amp;utm_medium=typeform&amp;utm_content=typeform-embedded-poweredbytypeform&amp;utm_term=EN" style="color: #999" target="_blank">Typeform</a> </div>
                  </div>
                </div>
              <!-- </div> -->
