          ...
          <form action="upload.php" method="post" enctype="multipart/form-data">
            ...
            <div class='form-group form-inline'>
              ...
              <a class='btn btn-default' style=' margin-bottom:5px'
                  href="https://api.23andme.com/authorize/?redirect_uri=http://localhost:8000/receive&response_type=code&client_id=a2e401e2dc7aa172df1b466597edcb8b&scope=basic rs123">
