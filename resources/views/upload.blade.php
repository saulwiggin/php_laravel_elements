        ...
        font-family: walsheim;height:40'><span style='position:relative;left:-10px;'><img style='height:30px;margin-top:-2px;'src='{{asset('img/icons/Light_Green/Nell_Icons_Light_Green_CMYK-01.png')}}'><span style='  font-family: walsheim;font-size:18px;position:relative;top:2px;'>Upload Genome</span></span></a>
            ...
            <div class='form-group form-inline' style='margin-top:-40px;'>
              ...
              <a class='btn btn-default' style="font-size: 15px; width:200px;height:40px; margin-top:5px;margin-left:10px;
                  font-family: walsheim"href='http://eepurl.com/djZ_tn'><span style='position:relative;left:-40px;top:-2px;'><img style='height:30px;margin-bottom:5px;margin-left:40px;'src='{{asset('img/icons/Light_Green/Nell_Icons_Light_Green_CMYK-27.png')}}'><span style='margin-left:20px;font-family: walsheim;font-size:18px;postion:relative;top:2px;'>Sign Up</span></span></a>
            </div>
          </form>
        </div>
      </div>
