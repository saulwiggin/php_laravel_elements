            ...
            <!-- container (chart - welcome) -->
               <div class='chart_container'>
                <div class="row slideanim">
                  <div class='mission_statement_container w3-container' style='width:100%;'>
              ...
              <div id="pricing" class="container-fluid">
                ...
                <div class="row slideanim">
                   <div class="col-sm-4 col-xs-12">
                     ...
                     usemap="#usa" >
                     <map id="usa_image_map" name="usa" style="width:705px;height:436;">
                         <!-- the first Texas area shows how to exclude interior shapes using nohref -->
